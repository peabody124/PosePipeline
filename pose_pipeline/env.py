...
dependencies = {
    ...
    "PoseFormer": {"rel_path": "PoseFormer", "env_var": "POSEFORMER_PATH", "git_repo": "zczcwh/PoseFormer"},
    "VIBE": {"rel_path": "VIBE", "env_var": "VIBE_PATH", "git_repo": "mkocabas/VIBE"},
    "MEVA": {"rel_path": "MEVA", "env_var": "MEVA_PATH", "git_repo": "ZhengyiLuo/MEVA"},
    "PARE": {"rel_path": "PARE", "env_var": "PARE_PATH", "git_repo": "mkocabas/PARE"},
    "PIXIE": {"rel_path": "PIXIE", "env_var": "PIXIE_PATH", "git_repo": "pixie-io/pixie"},
    "humor": {"rel_path": "humor/humor", "env_var": "HUMOR_PATH", "git_repo": "davrempe/humor"},
    "FairMOT": {"rel_path": "FairMOT/src/lib", "env_var": "FAIRMOT_PATH", "git_repo": "ifzhang/FairMOT"},
    "DCNv2": {"rel_path": "DCNv2/DCN", "env_var": "DCNv2_PATH", "git_repo": "CharlesShang/DCNv2"},
    "TransTrack": {"rel_path": "TransTrack", "env_var": "TRANSTRACK_PATH", "git_repo": "PeizeSun/TransTrack"},
    "ProHMR": {"rel_path": "ProHMR", "env_var": "PROHMR_PATH", "git_repo": "nkolot/ProHMR"},
    "TraDeS": {"rel_path": "TraDeS/src/lib", "env_var": "TRADES_PATH", "git_repo": "yaodongyu/TRADES"},
    "Pose3D-RIE": {"rel_path": "Pose3D-RIE", "env_var": "RIE_PATH", "git_repo": "paTRICK-swk/Pose3D-RIE"},
    "VideoPose3D": {
        "rel_path": "VideoPose3D",
        "env_var": "VIDEOPOSE3D_PATH",
        "git_repo": "facebookresearch/VideoPose3D",
    },
    "PoseAug": {"rel_path": "PoseAug", "env_var": "POSEAUG_PATH", "git_repo": "jfzhang95/PoseAug"},
}
...
def set_environmental_variables(dependencies=dependencies, git_clone=False):
    ...
    for package in dependencies:
        try:
            package_path = find_full_path(get_pose_root_package_dir(), dependencies[package]["rel_path"])
