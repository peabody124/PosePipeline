...
def mmpose_HPE(key, method="RTMPoseHand5"):
    ...
    if method == "RTMPoseHand5":
        pose_model_cfg = os.path.join(
            path,
            "../../3rdparty/mmpose/config/hand_2d_keypoint/rtmpose/hand5/rtmpose-m_8xb256-210e_hand5-256x256.py",
        )
        ...
        pose_model_cfg = os.path.join(
            path,
            "../../3rdparty/mmpose/config/hand_2d_keypoint/rtmpose/coco_wholebody_hand/rtmpose-m_8xb32-210e_coco-wholebody-hand-256x256.py",
        )
        ...
        pose_model_cfg = os.path.join(
            path,
            "../../3rdparty/mmpose/config/hand_2d_keypoint/topdown_heatmap/freihand2d/td-hm_res50_8xb64-100e_freihand2d-224x224.py",
        )
        ...
        pose_model_cfg = os.path.join(
            path,
            "../../3rdparty/mmpose/config/hand_2d_keypoint/topdown_heatmap/rhd2d/td-hm_hrnetv2-w18_dark-8xb64-210e_rhd2d-256x256.py",
        )
        ...
        pose_model_cfg = os.path.join(
            path,
            "../../3rdparty/mmpose/config/hand_2d_keypoint/topdown_heatmap/onehand10k/td-hm_hrnetv2-w18_udp-8xb64-210e_onehand10k-256x256.py",
        )
